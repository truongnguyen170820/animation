...
class _PlaygroundPageState extends State<PlaygroundPage> {
  ...
  Widget build(BuildContext context) {
    print(date);
    return Scaffold(
      appBar: appbarDefault(context, widget.hotel.hotelName,
          bgColor: ColorUtils.underlined),
  ...
  Widget _buildBodyPage(Hotel hotel) {
    return Container(
      margin: EdgeInsets.only(
          left: setWidth(16), right: setWidth(16), top: setHeight(10)),
      child: Column(
        ...
        children: [
          ...
          Text(hotel.LocationDetail ?? "",
              style: FontUtils.MEDIUM
                  .copyWith(color: ColorUtils.gray3, fontSize: setSp(12))),
          Container(
                  ...
                  children: [
                    Text(
                      ...
                      style: FontUtils.BOLD.copyWith(
                          color: ColorUtils.WHITE_TEXT, fontSize: setSp(20)),
                    ),
                    Text("Việt Nam",
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      "* Đóng cửa",
                      style: FontUtils.MEDIUM.copyWith(
                          color: ColorUtils.underlined, fontSize: setSp(10)),
                    )
                  ],
                )
              ],
              ...
              : Column(
                  ...
                  children: [
                    Text(
                      "HỆ THỐNG SUNWORLD",
                      style: FontUtils.BOLD.copyWith(
                          color: ColorUtils.NUMBER_PAGE, fontSize: setSp(20)),
                    ),
                    Container(
          ...
          hotel.contact == null ? SizedBox() : _buildContact(hotel.contact)
        ],
      ),
    );
  }
  ...
  Widget _buildNews(News news) {
    return Container(
      width: setWidth(230),
      margin: EdgeInsets.only(
          left: setWidth(16), top: setHeight(16), bottom: setHeight(16)),
      padding: EdgeInsets.only(
          left: setWidth(10), top: setHeight(16), right: setWidth(10)),
      decoration: BoxDecoration(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: setHeight(5)),
          Text(news?.nameNews ?? "",
              style: FontUtils.BOLD.copyWith(fontSize: setSp(15)),
  ...
  Widget _buildLogo(logoImage logo) {
    return Container(
      ...
      margin: EdgeInsets.only(
          left: setWidth(16), top: setHeight(5), bottom: setHeight(16)),
      decoration: BoxDecoration(
          color: ColorUtils.WHITE_TEXT,
          borderRadius: BorderRadius.circular(10),
          border: Border.all(color: ColorUtils.gray)),
      child: Image.asset(
        getAssetsImage(logo.imageUrl),
        fit: BoxFit.cover,
        scale: 1.2,
      ),
    );
  ...
  Widget _buildC(String name, String detail) {
    return Row(
      ...
      children: [
        Text(name,
            style: FontUtils.BOLD.copyWith(color: ColorUtils.colorStatus)),
        Text(detail,
            style: FontUtils.BOLD.copyWith(color: ColorUtils.WHITE_TEXT))
      ],
    );
  }
}

List<String> listSlideImageHL = [
  'hlp.jpg',
  'hlp2.jpg',
  'hlp1.jpg',
  'banahi.jpg',
